...
pyinstaller --onefile --name=nanobroker-linux main.py
# Resultado: dist/nanobroker-linux
```
...
```powershell
python -m pip install pyinstaller
pyinstaller --onefile --name=nanobroker-win64 main.py
:: Resultado: dist\nanobroker-win64.exe
```

## Binario pre-compilado

Los lanzamientos se generan automáticamente desde GitHub Actions al hacer push a `main`. Descargar desde [Releases](https://github.com/cgmark101/nexo_nanobroker/releases).
